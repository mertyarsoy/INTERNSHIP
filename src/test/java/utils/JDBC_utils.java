...
public class JDBC_utils {
    ...
    private static Statement ConnectToSQL() {
        try {
            connection = DriverManager.getConnection(ConfigReader_SQL.readProperty("connection_url"),
                    ConfigReader_SQL.readProperty("username"), ConfigReader_SQL.readProperty("password"));
